...
def log_timing(logger: logging.Logger, operation: str, duration: float, 
               request_id: Optional[str] = None, additional_info: Optional[str] = None) -> None:
    """
    ...
    logger.info(f"{request_prefix}[TIMING] {operation} completed in {duration:.4f} seconds{info_suffix}") 